...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    source$.subscribe((data) => console.log(`沒 sharePlay, 第 1 次 subscribe: ${data}`));
    source$.subscribe((data) => console.log(`沒 sharePlay, 第 2 次 subscribe: ${data}`));
    ...
    source2$.subscribe((data) => console.log(`有 sharePlay, 第 1 次 subscribe: ${data}`));
    source2$.subscribe((data) => console.log(`有 sharePlay, 第 2 次 subscribe: ${data}`));
  }
}
